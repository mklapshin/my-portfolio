  ...
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">
        Оперативность принятия мер по обращениям жильцов
      </h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val232)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val415 }}</div>
    <div class="legend-2">
...
export default {
  data() {
    return {
      rowKeysPercent: ["Row239", "Row240", "Row241", "Row242", "Row243"],
    };
  },
  props: ["val232", "val415", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
