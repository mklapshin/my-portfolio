    ...
    <div class="graphs-block">
      <svg width="140px" height="140px" viewBox="0 0 42 42" class="donut">
        ...
        <circle
          ...
          stroke-width="5"
          :stroke-dasharray="
            parseFloat(val42) * 100 + ' ' + (100 - parseFloat(val42) * 100)
          "
        ...
        <circle
          ...
          stroke-width="5"
          :stroke-dasharray="
            parseFloat(val43) * 100 + ' ' + (100 - parseFloat(val43) * 100)
          "
        ...
        <circle
          ...
          stroke-width="5"
          :stroke-dasharray="
            parseFloat(val44) * 100 + ' ' + (100 - parseFloat(val44) * 100)
          "
          :stroke-dashoffset="
            calcDashoffset1(parseFloat(val42) * 100, parseFloat(val43) * 100)
          "
        ></circle>
