<template>
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">Состояние мест общего пользования</h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val266)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val421 }}</div>
    <div class="legend-2">
...
export default {
  ...
  props: ["val266", "val421", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
