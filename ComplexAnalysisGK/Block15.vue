<template>
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">Состояние паркинга</h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val254)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val419 }}</div>
    <div class="legend-2">
...
export default {
  ...
  props: ["val254", "val419", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
