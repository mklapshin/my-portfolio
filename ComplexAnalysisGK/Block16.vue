  ...
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">
        Бесперебойная работа переговорных устройств
      </h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val262)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val420 }}</div>
    <div class="legend-2">
...
export default {
  data() {
    return {
      rowKeysPercent: ["Row269", "Row270", "Row271"],
    };
  },
  props: ["val262", "val420", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
