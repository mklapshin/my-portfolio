<template>
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">Понятность расчётов в квитанции</h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val238)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val416 }}</div>
    <div class="legend-2">
...
export default {
  data() {
    return {
      rowKeysPercent: ["Row245", "Row246", "Row247", "Row248", "Row249"],
    };
  },
  props: ["val238", "val416", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
