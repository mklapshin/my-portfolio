  ...
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">
        Состояние зеленых насаждений на придомовой территории
      </h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val273)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val422 }}</div>
    <div class="legend-2">
...
export default {
  ...
  props: ["val273", "val422", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
