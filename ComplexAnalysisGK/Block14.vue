  ...
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">
        Чистота и порядок на придомовой территории
      </h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val249)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val418 }}</div>
    <div class="legend-2">
...
export default {
  data() {
    return {
      rowKeysPercent: ["Row256", "Row257", "Row258", "Row259"],
    };
  },
  props: ["val249", "val418", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
