<template>
  <div class="content">
    <div class="header">
      <h3 class="header-paragraph">Чистота и порядок в доме</h3>
      <h3 class="header-bar">{{ roundToFixed1(parseFloat(val244)) }} &#42;</h3>
    </div>
    ...
    <div class="legend-1">База (поставили оценку ниже 4): {{ val417 }}</div>
    <div class="legend-2">
...
export default {
  data() {
    return {
      rowKeysPercent: ["Row251", "Row252", "Row253", "Row254"],
    };
  },
  props: ["val244", "val417", "matrixData", "slideBody"],
  computed: {
    sortedData: function () {
